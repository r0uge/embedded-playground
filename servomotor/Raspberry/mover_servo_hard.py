...
# Utiliza implmentación de PWM basada en Hardware (movimientos mas preciso y suaves, reduciendo vibraciones)
...
# Crea una instancia de la fábrica de pines pigpio
